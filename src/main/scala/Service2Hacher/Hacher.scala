...
object Hacher {
  ...
  def hacher(): Unit = {
    ...
    /** lit le fichier csv* */
    val dataframe: org.apache.spark.sql.DataFrame = sparkSession.read.option("header", true).csv("data\\steph.csv") //.csv("hdfs://172.31.249.118:9000/user/administrator/complianceRGPDMS")
